...
public:
    ...
    vector<UniformBspline> topo_traj_pos1_;
    vector<UniformBspline> topo_traj_pos2_;
    vector<UniformBspline> refines_;
...
//     // multiple topological trajectories
//     vector<UniformBspline> topo_trajs_pos1_;
//     vector<UniformBspline> topo_trjas_pos2_;
//     vector<UniformBspline> refines_;

//     void clearTopoPaths()
//     {
//         topo_trajs_pos1_.clear();
//         topo_trjas_pos2_.clear();
//         topo_graph_.clear();
//         topo_paths_.clear();
//         topo_filtered_paths_.clear();
//         topo_select_paths_.clear();
