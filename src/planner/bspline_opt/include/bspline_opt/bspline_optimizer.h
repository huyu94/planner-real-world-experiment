 ...
 * The format of points: 3 x N matrix, each col is a point
*/
...
public:
    ...
    /* main API */
    void setEnvironment(const DspMap::Ptr &env);
...
private:
    ...
    double                          lambda1_s_;             // phase 1 smoothness weight
    double                          lambda1_g_, new_lambda1_g_;             // phase 1 guide weight
    double                          lambda1_d_;             // phase 1 feasibility weight
    double                          lambda2_s_;             // phase 3 smoothness weight
    double                          lambda2_d_;             // phase 3 feasibility weight
    double                          lambda2_f_;             // phase 3 fitness weight
